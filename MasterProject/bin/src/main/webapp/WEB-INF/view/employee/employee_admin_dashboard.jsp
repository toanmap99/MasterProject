      ...
      <div id="content">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                <a class="dropdown-item d-flex align-items-center" href="/admin/employee-department-table/export/html">
                  <div class="mr-3">
                  ...
                  <div>
                    ...
                    <span class="font-weight-bold">A new month Department report(HTML) is ready to download!</span>
                  </div>
                </a>
                ...
                <a class="dropdown-item d-flex align-items-center" href="/admin/employee-branch-table/export/HTML">
                  <div class="mr-3">
                  ...
                  <div>
                    <div class="small text-gray-500">HTML Format</div>
                    A new month Branch report(HTML) is ready to download!
                  </div>
                </a>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
            <a href="/admin/employee-department-table/export/pdf">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Get Department Report</div>
            ...
            <!-- Get Branch Report -->
            <div class="col-xl-3 col-md-6 mb-4">
            <a href="/admin/employee-branch-table/export/pdf">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Get Branch Report</div>
