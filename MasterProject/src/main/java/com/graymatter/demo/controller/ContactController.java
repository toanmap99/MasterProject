...
public class ContactController {
	...
	// Contact module that will send message to actual an email.
	...
	public String submitContact(HttpServletRequest request,
		...
		helper.setFrom("seniorproject255@gmail.com", "Company Employees"); // Set your User Email
		helper.setTo("toanmap99@yahoo.com.vn"); // Set your admin email here
		...
		ClassPathResource resource = new ClassPathResource("/static/images/EmployeeLogo.png"); // adding a logo image to the message
